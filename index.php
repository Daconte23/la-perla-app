        ...
        <section class="seccion2">
            ...
            <div class="formulario" id="formulario">
                ...
                <div id="mc_embed_signup">
                    <form class="form" action="#" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_self" class="">
                        <div id="mc_embed_signup_scroll">
                            ...
                            <div class="mc-field-group">
                                ...
                                <input type="text" value="" name="FNAME" class="required" id="mce-FNAME" required disabled>
                                <span id="mce-FNAME-HELPERTEXT" class="helper_text"></span>
                            </div>
                            <div class="mc-field-group">
                                <label for="mce-EMAIL">Correo Electrónico <span class="asterisk">*</span>
                                </label>
                                <input type="email" value="" name="EMAIL" class="required email" id="mce-EMAIL" required disabled>
                                <span id="mce-EMAIL-HELPERTEXT" class="helper_text"></span>
                            </div>
                            <div class="mc-field-group size1of2">
                                <label for="mce-PHONE">Teléfono <span class="asterisk">*</span>
                                </label>
                                <input type="text" name="PHONE" class="required" value="" id="mce-PHONE" required disabled>
                                <span id="mce-PHONE-HELPERTEXT" class="helper_text"></span>
                            </div>
                            <div class="mc-field-group">
                                <label for="mce-RSOCIAL">Nombre o Razón Social <span class="asterisk">*</span>
                                </label>
                                <input type="text" value="" name="RSOCIAL" class="required" id="mce-RSOCIAL" required disabled>
                                <span id="mce-RSOCIAL-HELPERTEXT" class="helper_text"></span>
                            </div>
                            <div class="mc-field-group">
                                <label for="mce-TIPOID">Cuenta con <span class="asterisk">*</span>
                                </label> <br>
                                <select name="TIPOID" class="required" id="mce-TIPOID" required disabled>
                                    <option value=""></option>
                            ...
                            <div class="mc-field-group size1of2">
                                ...
                                <input type="number" name="IDNUMBER" class="required" value="" id="mce-IDNUMBER" required disabled>
                            ...
                            <div class="radio">
                                ...
                                <input type="checkbox" id="radio" name="radio" required disabled>
